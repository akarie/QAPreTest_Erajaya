...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/Make appointment/input_Visit Date'), '06/12/2024')

WebUI.setText(findTestObject('Page_CURA Healthcare Service/Make appointment/textarea_Comment'), 'Success Submit')
