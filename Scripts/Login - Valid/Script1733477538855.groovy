...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/Login/input_Username'), 'John Doe')

WebUI.setText(findTestObject('Page_CURA Healthcare Service/Login/input_Password'), 'ThisIsNotAPassword')
